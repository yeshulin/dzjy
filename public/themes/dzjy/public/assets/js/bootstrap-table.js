...
//        paginationFirst: '&lsaquo;&lsaquo;',
        paginationPreText: '&lsaquo;',
        paginationNextText: '&rsaquo;',
//        paginationLast: '&rsaquo;&rsaquo;',
        search: false,
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                '<li class="page-first"><a href="javascript:void(0)">' + this.options.paginationFirst + '</a></li>',
            ...
            html.push(
                ...
                '<li class="page-last"><a href="javascript:void(0)">' + this.options.paginationLast + '</a></li>',
                '</ul>',
                '</div>');
        }
